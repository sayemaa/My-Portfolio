        ...
        <footer class="footer footer-center p-10 bg-base-300 text-base-content rounded">
            <div>
                <div class="grid grid-flow-col gap-5">
                    <a target="_blank" rel="noReferrer" href="https://github.com/sayemaa" className='hover:text-primary transition-all duration-300 text-2xl' smooth={true} ><FaLinkedinIn /></a>
