...
const About = () => {
    return (
        <div id="about" className='max-w-7xl mx-auto lg:px-12'>
            <div class="hero min-h-screen">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div className='lg:ml-7 px-3 lg:px-0'>
                        ...
                        <h4 class="text-xl text-primary font-bold my-6 text-center lg:text-start">Junior Web Developer</h4>
                        ...
                        <Link to="contact" className="btn text-white font-bold btn-primary" smooth>Get In Touch</Link>
                    </div>
                </div>
            </div>
        </div>
